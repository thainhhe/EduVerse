                            ...
                            <TableBody>
                                {reports.map((item) => (
                                    <TableRow key={item._id}>
                                        ...
                                        <TableCell>{item.assigneeId?.username || "Admin"}</TableCell>
                                        <TableCell>{item.issueType}</TableCell>
                                        <TableCell>{item.description}</TableCell>
                                        <TableCell className="flex items-center gap-2">
                                            <span
                                                className={`px-2 py-1 rounded text-white text-sm ${item.status === "open"
                                                    ? "bg-blue-500"
                                        ...
                                        <TableCell>
                                            ...
                                            >
                                                ...
                                                <SelectContent>
                                                    <SelectItem value="open" className="text-blue-600 font-semibold hover:bg-blue-100">
                                                        Open
                                                    </SelectItem>
                                                    <SelectItem value="inprogress" className="text-yellow-600 font-semibold hover:bg-yellow-100">
                                                        In Progress
                                                    </SelectItem>
                                                    <SelectItem value="resolved" className="text-green-600 font-semibold hover:bg-green-100">
                                                        Resolved
                                                    </SelectItem>
                                                </SelectContent>
                                            </Select>
