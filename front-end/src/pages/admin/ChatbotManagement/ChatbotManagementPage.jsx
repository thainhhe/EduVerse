...
const ChatbotManagementPage = () => {
    ...
    async function viewHistory(userId, username) {
        try {
            ...
            result.userName = username || (result.user && result.user.username) || undefined;
    ...
    async function clearHistory(userId) {
        if (!window.confirm("Xác nhận xóa tất cả tin nhắn của người dùng này?")) return;
        try {
                ...
                <div>
                    <Card>
                        ...
                        <CardContent className="p-0 overflow-auto">
                            <div className="p-4">
                                <form className="flex items-center gap-3 mb-4" onSubmit={onSearch}>
                                    <Input
                        ...
                        <Card className="mt-4">
                            ...
                            <CardContent className="p-4">
                                ...
                                <div className="mt-3 space-x-2">
                                    ...
                                    <Button
                                        className="bg-red-600 text-white"
                                        onClick={() => deleteHistory(String(selectedHistory.userId))}
                                    >
                                        Delete
                                    </Button>
                                </div>
            ...
            {tab === "faq" && (
                <Card>
                    ...
                    <CardContent className="p-6 text-sm text-muted-foreground">
                        Section for managing auto-FAQ entries (CRUD). Implement UI/actions as needed.
                    </CardContent>
                </Card>
            )}
        </div>
