    ...
    <div className="min-h-screen bg-gray-50 py-8">
      <div className="container mx-auto px-4 max-w-4xl">
        <div className="mb-8">
          ...
          <p className="text-gray-600">Manage your CourseFlow account, preferences, and notification settings.</p>
        </div>
        ...
        <Card className="mb-6">
          ...
          <CardContent className="space-y-6">
            ...
            <div className="space-y-2">
              ...
              {!showChangeForm ? (
                <div className="flex gap-2">
                  ...
                  <Button variant="outline" onClick={handleStartChange} disabled={!profile.id}>
                ...
                <div className="space-y-3">
                  ...
                  <div className="flex gap-2">
                    ...
                    <Button variant="ghost" onClick={handleCancelChange} disabled={changing}>
                      Cancel
                    </Button>
                  </div>
                </div>
            ...
            <div className="flex gap-2">
              <Button className="bg-indigo-600 hover:bg-indigo-700" onClick={handleSaveProfile} disabled={loading}>
                <Pencil className="mr-2 h-4 w-4" />
                Save Changes
              </Button>
              <Button variant="ghost" onClick={() => window.location.reload()} disabled={loading}>
                Reset
              </Button>
            </div>
          </CardContent>
