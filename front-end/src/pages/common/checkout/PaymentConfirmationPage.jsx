            ...
            <div className="w-full max-w-lg text-center bg-white p-8 sm:p-12 rounded-xl shadow-lg">
                ...
                <div className="bg-gray-50 rounded-lg p-6 text-left space-y-4 mb-8 border">
                    <div className="flex justify-between">
                        ...
                        <span className="font-medium text-gray-800">{transactionDetails.courseName}</span>
                    </div>
                    <div className="flex justify-between">
                    ...
                    <div className="flex justify-between">
                        ...
                        <span className="font-medium text-gray-800">${transactionDetails.amountPaid}</span>
                    </div>
                </div>
