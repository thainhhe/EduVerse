      ...
      <div className="container mx-auto px-4 max-w-5xl">
        ...
        <div className="bg-white rounded-lg shadow-sm p-2 sm:p-4 mb-4">
          ...
          <div className="flex flex-col md:flex-row items-center md:items-end gap-6 px-6 -mt-12 mb-8">
            <Avatar className="w-32 h-32 border-4 border-white shadow-lg z-10">
              <AvatarImage src={avatar || "/default-avatar.png"} alt={username} className="object-cover" />
              <AvatarFallback className="text-2xl bg-gray-100">{username?.charAt(0)}</AvatarFallback>
            </Avatar>
            ...
            <div className="flex-1 text-center md:text-left pt-2 md:pt-0 md:mb-2">
              ...
              <div className="flex flex-wrap items-center justify-center md:justify-start gap-3 text-gray-600 mt-1">
                <span className="bg-indigo-50 text-indigo-700 px-3 py-0.5 rounded-full text-sm font-medium border border-indigo-100">
                  Instructor
                </span>
          ...
          {/* Courses */}
          <section className="mb-4">
            <h2 className="text-xl sm:text-2xl font-bold text-gray-900 mb-6 flex items-center gap-2">Courses Taught</h2>
                  ...
                  .map((course) => (
                    ...
                    >
                      <div className="relative h-48 overflow-hidden">
                        <img
                          src={course.thumbnail ? `${course.thumbnail}` : "/course-placeholder.png"}
                          alt={course.title}
                        ...
                        <div className="absolute top-3 right-3 bg-white/90 backdrop-blur-sm px-2 py-1 rounded-md text-xs font-bold text-indigo-600 shadow-sm">
                          {course.duration?.value ? `${course.duration.value} ${course.duration.unit}` : "N/A"}
                        </div>
                      </div>
