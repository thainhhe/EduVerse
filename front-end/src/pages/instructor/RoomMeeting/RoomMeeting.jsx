                ...
                <CardContent>
                    {!courseId && (
                        <div className="mb-4 p-3 rounded bg-yellow-50 text-sm text-yellow-800">
                            Không tìm thấy courseId. Hãy mở trang này từ trang khóa học (navigate with state:{" "}
                            {"{ id: <courseId> }"}) hoặc thêm ?courseId=&lt;id&gt; vào URL.
                        </div>
                    )}
                                ...
                                <div key={id} className="flex justify-between items-center p-3 border rounded-md">
                                    <div>
                                        ...
                                        {link ? (
                                            ...
                                            <div className="text-sm text-muted-foreground">No meeting link yet</div>
                                        )}
                                    </div>
                                    ...
                                    <div className="flex gap-2">
                                        ...
                                        <Button variant="ghost" size="icon" onClick={() => handleDeleteRoom(id)}>
