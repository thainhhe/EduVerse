          ...
          <div className="space-y-3">
            ...
            <div className="border-2 border-dashed border-gray-300 rounded-xl bg-white shadow-sm relative">
              ...
              <div className="flex flex-col items-center justify-center text-gray-500 min-h-[250px]">
                {thumbnailPreview || existingThumbnailUrl ? (
                  ...
                  <div className="flex flex-col items-center justify-center min-h-[250px]">
                    ...
                    <Button type="button" variant="outline" disabled={!isEditable} onClick={handleBrowse}>
                      Browse images
                    </Button>
                  </div>
                )}
              ...
              <div className="absolute bottom-4 right-4 flex gap-3">
                ...
                <Button disabled={!isEditable} className="bg-indigo-600 text-white" onClick={handleBrowse}>
                  Select
                </Button>
              </div>
            </div>
            ...
            <div>
              ...
              <div className="flex gap-2">
                <Input
                  ...
                  placeholder="e.g. 30"
                />
                <Select disabled={!isEditable} value={durationUnit} onValueChange={(v) => setDurationUnit(v)}>
