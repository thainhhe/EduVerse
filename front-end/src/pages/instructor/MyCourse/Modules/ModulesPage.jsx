...
const ModulesPage = () => {
    ...
    const courseIdFromState = location?.state?.id ?? params?.id ?? getCourseIdFromQuery() ?? storageCourseId ?? null;
    ...
    const fetchQuizCounts = async (courseId, modulesList = []) => {
        ...
        try {
            ...
            console.debug("fetchQuizCounts - courseRes:", courseRes, "=>", courseItems.length);
    ...
    return (
        <div className="flex-row max-w-full">
            <div className="flex justify-between items-center">
                <div>
                    <h1 className="text-2xl font-semibold max-w-[400px] truncate">Course : {sessionCourse.title}</h1>
                </div>
                <div className="flex items-center gap-2">
                    ...
                    <Button className="bg-indigo-600 hover:bg-indigo-700 text-white">Submit Course</Button>
                </div>
            </div>
                    ...
                    <CardContent className="space-y-4">
                        ...
                        {isQuizManagerOpen && (
                            <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50">
                                <div className="bg-white rounded-lg shadow-lg w-full max-w-8/12 p-6 relative overflow-y-auto max-h-[90vh]">
                                    <QuizManager
