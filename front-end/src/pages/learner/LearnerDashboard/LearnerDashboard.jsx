...
import { FaCalendarAlt, FaBook, FaUserTie, FaCog, FaChartLine, FaBolt } from "react-icons/fa";
                        ...
                        <>
                            ...
                            <div className="grid md:grid-cols-3 gap-6">
                                {detailedEnrollments.map((enr) => {
                                    ...
                                    const progressValue = Math.max(0, Math.min(100, enr.progress ?? 0));
                    ...
                    <CardContent>
                        <div className="space-y-3">
                            ...
                            {recentActivities.map((act) => (
                                ...
                                >
                                    <div>
                                        <div className="text-sm font-medium">{act.quizId?.title}</div>
                                        <div className="text-xs text-gray-500">
