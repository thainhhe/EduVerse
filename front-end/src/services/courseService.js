...
export const updateModule = (id, payload) => api.put(`/modules/update/${id}`, payload);
...
export const getQuizzesByCourse = (courseId) => api.get(`/quiz/course/${courseId}`);
export const getQuizzesByModule = (moduleId) => api.get(`/quiz/module/${moduleId}`);
