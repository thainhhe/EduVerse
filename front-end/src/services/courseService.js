...
export const getCollaborativeCourse = (id) =>
  api.get(`/courses/instructor-collaborative/${id}`);
export const getUerInCourse = (id) =>
  api.get(`/courses/instructor/course-user/${id}`);
