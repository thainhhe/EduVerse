...
roomRouter.post(
    "/create",
    validate_schema(roomValidator.createRoomValidator),
    room_meting_controller.create_room
);
roomRouter.put(
    "/update/:id",
    validate_schema(roomValidator.updateRoomValidator),
    room_meting_controller.update_room
);
